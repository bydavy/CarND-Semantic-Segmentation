...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    vgg_layer7 = tf.layers.conv2d(vgg_layer7_out, num_classes, 1, padding='SAME', kernel_initializer=kernel_initializer)

    fcn_layer1 = tf.layers.conv2d_transpose(vgg_layer7, num_classes, 4, 2, 'SAME', kernel_initializer=kernel_initializer)
    vgg_layer4 = tf.layers.conv2d(vgg_layer4_out, num_classes, 1, padding='SAME', kernel_initializer=kernel_initializer)
    combined_layer1 = tf.add(vgg_layer4, fcn_layer1)

    fcn_layer2 = tf.layers.conv2d_transpose(combined_layer1, num_classes, 4, 2, 'SAME', kernel_initializer=kernel_initializer)
    vgg_layer3 = tf.layers.conv2d(vgg_layer3_out, num_classes, 1, padding='SAME', kernel_initializer=kernel_initializer)
    combined_layer2 = tf.add(vgg_layer3, fcn_layer2)

    return tf.layers.conv2d_transpose(combined_layer2, num_classes, 16, 8, 'SAME', kernel_initializer=kernel_initializer)
